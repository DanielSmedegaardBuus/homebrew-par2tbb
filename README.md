...
To use it, tap it: `brew tap DanielSmedegaardBuus/homebrew-par2tbb`, and then install as usual. I won't be allowed to add par2tbb back into homebrew-core unless I have a page with stars and forks and some activity, so please help out with that! Star me, fork me, write me something :D
